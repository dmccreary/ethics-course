...
|-------------|-------|------|-------|
| Chapters | 8 | [Chapters](../chapters/index.md) | Number of chapter directories |
| Concepts | 250 | [Concept List](./concept-list.md) | Concepts from learning graph |
| Glossary Terms | 247 | [Glossary](../glossary.md) | Defined terms |
| FAQs | 49 | [FAQ](../faq.md) | Frequently asked questions |
| Quiz Questions | 86 | - | Questions across all chapters |
...
|-------------|-------------|---------------|-------|
| Diagrams | 43 | 43 | H4 headers starting with '#### Diagram:' |
| Equations | 9 | 9 | LaTeX expressions (inline and display) |
| Total Words | 75,874 | 57,011 | Words in markdown files |
| Links | 176 | 145 | Hyperlinks in markdown format |
| Equivalent Pages | 316 | 241 | Estimated pages (250 words/page + visuals) |
