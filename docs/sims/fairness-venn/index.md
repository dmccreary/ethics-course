...
The models queried were:
- **Claude** (Anthropic)
- **OpenAI GPT** (ChatGPT 5.2)
- **Grok** (xAI)
- **DeepSeek**
...
- [Claude response](../chapters/08-fairness/claude.md)
- [OpenAI response](../chapters/08-fairness/openai.md)
- [Grok response](../chapters/08-fairness/grok.md)
- [DeepSeek response](../chapters/08-fairness/deepseek.md)
